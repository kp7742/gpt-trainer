...
def main():
    ...
    final_batch = 256 # 512 with 2048 context, ~1.05M
    ...
    model_config.n_inner = 4 * 256
    model_config.n_positions = context_size
    ...
    model_size2 = sum(t.numel() for n, t in model.state_dict().items() if "wte" not in n)
    model_size3 = sum(t.numel() for n, t in model.named_parameters() if t.requires_grad and "wte" not in n)
